...
const decks = {
    words_normal: [
            ...
            persons: [
				...
				// --- FICTIONAL CHARACTERS (50 ITEMS) ---
    			{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Doraemon", a_th: "โดราเอมอน" },
   				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Son Goku", a_th: "ซง โกคู" },
  				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Pikachu", a_th: "พิกาจู" },
   				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Conan Edogawa", a_th: "โคนัน" },
  				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Monkey D. Luffy", a_th: "มังกี้ ดี ลูฟี่" },
  				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Naruto Uzumaki", a_th: "นารูโตะ" },
  				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Crayon Shin-chan", a_th: "ชินจัง" },
  				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Sailor Moon", a_th: "เซเลอร์มูน" },
  				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Ultraman", a_th: "อุลตร้าแมน" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Kamen Rider", a_th: "คาเมนไรเดอร์ / ไอ้มดแดง" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Mario", a_th: "มาริโอ้" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Sonic the Hedgehog", a_th: "โซนิค" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Pac-Man", a_th: "แพ็กแมน" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Hello Kitty", a_th: "เฮลโล คิตตี้" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Barbie", a_th: "บาร์บี้" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Elsa", a_th: "เอลซ่า" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Cinderella", a_th: "ซินเดอเรลล่า" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Snow White", a_th: "สโนว์ไวท์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Mickey Mouse", a_th: "มิกกี้ เมาส์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Winnie the Pooh", a_th: "วินนีเดอะพูห์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Buzz Lightyear", a_th: "บัซ ไลท์เยียร์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Shrek", a_th: "เชร็ค" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Minions", a_th: "มินเนี่ยน" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "SpongeBob SquarePants", a_th: "สพันจ์บ็อบ" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Garfield", a_th: "กาฟิลด์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Godzilla", a_th: "ก็อดซิลล่า" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "King Kong", a_th: "คิงคอง" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Spider-Man", a_th: "สไปเดอร์แมน" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Batman", a_th: "แบทแมน" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Superman", a_th: "ซูเปอร์แมน" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Iron Man", a_th: "ไอรอนแมน" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Captain America", a_th: "กัปตันอเมริกา" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Thor", a_th: "ธอร์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Hulk", a_th: "ฮัลค์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Thanos", a_th: "ทานอส" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Joker", a_th: "โจ๊กเกอร์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Harry Potter", a_th: "แฮร์รี่ พอตเตอร์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Lord Voldemort", a_th: "ลอร์ด โวลเดอมอร์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Darth Vader", a_th: "ดาร์ธ เวเดอร์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Yoda", a_th: "โยดา" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Jack Sparrow", a_th: "แจ็ค สแปร์โรว์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Sherlock Holmes", a_th: "เชอร์ล็อก โฮมส์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "James Bond", a_th: "เจมส์ บอนด์ (007)" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "John Wick", a_th: "จอห์น วิค" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "The Terminator", a_th: "เทอร์มิเนเตอร์ / คนเหล็ก" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Count Dracula", a_th: "แดร็กคูล่า" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Frankenstein", a_th: "แฟรงเกนสไตน์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Tarzan", a_th: "ทาร์ซาน" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Robin Hood", a_th: "โรบินฮู้ด" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Santa Claus", a_th: "ซานตาคลอส" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Saitama (One-Punch Man)", a_th: "ไซตามะ" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Satoru Gojo", a_th: "ซาโตรุ โกโจ" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Tanjiro Kamado", a_th: "ทันจิโร่ คามาโดะ" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "L (Death Note)", a_th: "แอล (Death Note)" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Patrick Star", a_th: "แพทริค สตาร์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Squidward Tentacles", a_th: "สควิดเวิร์ด" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Wednesday Addams", a_th: "เวนส์เดย์ แอดดัมส์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Pennywise", a_th: "เพนนีไวส์" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Legolas", a_th: "เลโกลัส" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Gollum", a_th: "กอลลัม" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Neo (The Matrix)", a_th: "นีโอ (The Matrix)" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Shaggy Rogers", a_th: "แชกกี (Scooby-Doo)" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Willy Wonka", a_th: "วิลลี่ วองก้า" },
				{ q: "Who am I? (Fictional Character)", q_th: "ฉันคือใคร? (ตัวละครสมมติ)", a: "Rick Sanchez", a_th: "ริก ซานเชซ" },
				{ q: "Who am I? (Internet / Meme)", q_th: "ฉันคือใคร? (ตัวละครมีม)", a: "Pepe the Frog", a_th: "เปเป้ กบเขียว" },
				
				// --- FAMOUS REAL PERSONS (50 ITEMS) ---
				// ACTORS & DIRECTORS
            ...
            facts_th: [
                ...
                { q: "เที่ยวบินพาณิชย์ที่มีระยะทางและเวลาเดินทางสั้นที่สุดในโลกในประเทศสกอตแลนด์ ใช้เวลาบินเฉลี่ยประมาณกี่นาที?", a: "ต่ำกว่า 2 นาที (ประมาณ 47 ถึง 90 วินาที)" },
                ...
                { q: "ในปี 1932 เกิดเหตุการณ์โรงพยาบาลจ่ายยาผิดพลาดครั้งใหญ่ในออสเตรเลีย โดยส่งมอบสิ่งใดที่เป็นยาพิษร้ายแรงให้กลุ่มหญิงตั้งครรภ์แทนยาสลบ?", a: "สารสตริกนิน (Strychnine)" },
                ...
                { q: "ในช่วงสงครามเย็น CIA เคยจ้างบุคลากรอาชีพใดมาช่วยเขียนคู่มือลับสอนวิธีแอบหย่อนยาพิษหรือยาสลบลงแก้วเครื่องดื่มของเป้าหมาย?", a: "นักมายากล" },
                ...
                { q: "บริษัทของเล่นยักษ์ใหญ่ระดับโลกอย่าง LEGO จากประเทศเดนมาร์ก ในช่วงยุคแรกเริ่มผลิตของเล่นทั้งหมดขึ้นจากวัสดุธรรมชาติชนิดใด?", a: "ไม้ (Wooden toys)" },
                ...
                { q: "ลิงกอริลลาสายพันธุ์ 'กอริลลาโลว์แลนด์ตะวันตก' มีความพิเศษและจดจำง่ายในเรื่องชื่อวิทยาศาสตร์ของมันอย่างไร?", a: "ใช้คำว่า Gorilla ซ้ำกัน 3 ครั้ง (Gorilla gorilla gorilla)" },
                { q: "ในปี 1986 เกิดภัยพิบัติแก๊สคาร์บอนไดออกไซด์ปะทุขึ้นมาจากใต้ทะเลสาบพลิกกลับคร่าชีวิตผู้คนรอบข้างไปกว่า 1,700 คน ทะเลสาบมรณะ Nyos นี้อยู่ในประเทศใดในทวีปแอฟริกา?", a: "ประเทศแคเมอรูน" },
                ...
                { q: "ปลากระเบนไฟฟ้าและปลาไหลไฟฟ้าสามารถปล่อยกระแสไฟฟ้าแรงสูงได้ แต่ปลาไหลไฟฟ้าสามารถปล่อยไฟได้แรงสูงสุดถึงกี่โวลต์?", a: "860 โวลต์" },
                { q: "ยุงลายไม่ได้ดูดเลือดทุกคนเท่ากัน แต่พวกมันชอบบินเข้าหาและกัดคนที่มีกรุ๊ปเลือดใดมากที่สุด?", a: "กรุ๊ปเลือด O" },
                ...
                { q: "หอไอเฟล ในกรุงปารีส สามารถขยายตัวสูงขึ้นได้มากถึง 15 เซนติเมตรในช่วงฤดูร้อนเนื่องจากปรากฏการณ์วิทยาศาสตร์ใด?", a: "การขยายตัวของเหล็กจากความร้อน" },
                ...
                { q: "คำว่า Wi-Fi ยอดฮิต ไม่ได้ย่อมาจากคำว่า Wireless Fidelity แต่แท้จริงแล้วย่อมาจากอะไร?", a: "ไม่ได้ย่อมาจากอะไรเลย (เป็นแค่นามสมมติต่างทางการตลาด)" },
                { q: "ชายชื่อ นีล อาร์มสตรอง มนุษย์คนแรกที่เหยียบดวงจันทร์ เมื่อเดินทางกลับถึงโลกเขาต้องทำสิ่งใดเหมือนนักท่องเที่ยวทั่วไป?", a: "ศุลกากร / ยื่นใบสำแดงของนำเข้า" },
				...
				{ q: "ผลไม้อะไรคือเบอร์รี่ทางพฤกษศาสตร์ระหว่าง กล้วย กับ สตรอว์เบอร์รี?", a: "กล้วย (สตรอว์เบอร์รีไม่ใช่เบอร์รี่ตามหลักพฤกษศาสตร์)" },
				{ q: "ผิวหนังจริงๆ ของหมีขั้วโลกมีสีอะไร?", a: "สีดำ (ส่วนขนนั้นโปร่งแสง ไม่ใช่สีขาว)" },
				{ q: "สัตว์อะไรมีจมูกถึง 4 อัน?", a: "ทาก (Slug)" },
				{ q: "ดาวเคราะห์ดวงไหนร้อนที่สุดในระบบสุริยะ?", a: "ดาวศุกร์ (ไม่ใช่ดาวพุธที่อยู่ใกล้ดวงอาทิตย์ที่สุด)" },
				{ q: "อาหารอะไรที่ไม่มีวันหมดอายุหรือเน่าเสีย?", a: "น้ำผึ้งแท้" },
				{ q: "ถั่วลิสง (Peanut) จัดเป็นถั่วประเภท Nut หรือไม่?", a: "ไม่ใช่ มันเป็นพืชตระกูลถั่วฝัก (Legume) แบบเดียวกับถั่วลันเตา" },
				...
				{ q: "น้ำ หรือ อากาศ ที่เสียงสามารถเดินทางผ่านได้เร็วกว่ากัน?", a: "น้ำ (เร็วกว่าประมาณ 4 เท่า)" },
				{ q: "อักษรใดในภาษาอังกฤษที่ถูกใช้บ่อยที่สุด?", a: "ตัว E" },
				{ q: "อวัยวะใดของผีเสื้อที่ใช้รับรสชาติอาหาร?", a: "เท้า" },
				{ q: "หอยทากสามารถนอนหลับต่อเนื่องได้นานที่สุดกี่ปี?", a: "3 ปี" },
				{ q: "สัตว์อะไรอั้นหายใจได้นานกว่าโลมา?", a: "สลอธ (อั้นได้นานถึง 40 นาทีเพื่อลดอัตราการเต้นของหัวใจ)" },
				...
				{ q: "เด็กทารกหรือผู้ใหญ่ ใครมีกระดูกมากกว่ากัน?", a: "ทารก (มีประมาณ 300 ชิ้น ส่วนผู้ใหญ่ชิ้นส่วนจะเชื่อมกันเหลือ 206 ชิ้น)" },
				{ q: "ส่วนใดของร่างกายมนุษย์ที่ไม่มีกล้ามเนื้อเลย?", a: "นิ้วมือ (ขยับได้ด้วยเส้นเอ็นที่เชื่อมกับกล้ามเนื้อแขน)" },
				{ q: "มีต้นไม้บนโลก หรือ ดาวฤกษ์ในกาแล็กซีทางช้างเผือก มากกว่ากัน?", a: "ต้นไม้บนโลก (มีประมาณ 3 ล้านล้านต้น)" },
				{ q: "แครอทในอดีตยุคแรกๆ มีสีอะไร?", a: "สีม่วง (หรือสีเหลือง)" },
				{ q: "มหาวิทยาลัยออกซ์ฟอร์ด กับ อาณาจักรแอซเท็ก อะไรเกิดก่อนกัน?", a: "มหาวิทยาลัยออกซ์ฟอร์ด (เก่ากว่าหลายร้อยปี)" },
				{ q: "ซอสมะเขือเทศเคยถูกใช้ทำอะไรในช่วงปี 1830?", a: "ใช้เป็นยารักษาโรค (เช่น อาการอาหารไม่ย่อย)" },
				{ q: "ขนมสายไหม (Cotton Candy) ถูกคิดค้นโดยคนอาชีพอะไร?", a: "ทันตแพทย์" },
				{ q: "ไฟแช็ก กับ ไม้ขีดไฟ อะไรถูกคิดค้นขึ้นก่อนกัน?", a: "ไฟแช็ก" },
				{ q: "สัตว์อะไรไม่สามารถเงยหน้ามองขึ้นไปบนฟ้าได้?", a: "หมู (เพราะโครงสร้างกระดูกคอ)" },
				{ q: "เฟรนช์ฟรายส์ (French Fries) มีต้นกำเนิดจริงๆ จากประเทศอะไร?", a: "เบลเยียม" },
				{ q: "สุนัขมีลายนิ้วมือเพื่อใช้ระบุตัวตนเหมือนมนุษย์หรือไม่?", a: "มี แต่มันอยู่ที่ 'จมูก' (Nose print)" },
				{ q: "วัวมี 'เพื่อนสนิท' หรือไม่?", a: "มี และพวกมันจะเครียดมากถ้าถูกจับแยกจากกัน" },
				{ q: "เล็บมือ หรือ เล็บเท้า ของมนุษย์ที่ยาวเร็วกว่ากัน?", a: "เล็บมือ (ยาวเร็วกว่าประมาณ 3-4 เท่า)" },
				{ q: "รอยเท้าของนักบินอวกาศบนดวงจันทร์จะอยู่ได้นานแค่ไหน?", a: "หลายล้านปี (เพราะดวงจันทร์ไม่มีลมหรือน้ำมาพัดพา)" },
				{ q: "ก้อนเมฆคิวมูลัสขนาดเฉลี่ยหนึ่งก้อนมีน้ำหนักประมาณเท่าไหร่?", a: "ประมาณ 500,000 กิโลกรัม (หรือเท่ากับช้าง 100 ตัว)" },
				{ q: "แอปเปิลลอยน้ำได้เพราะอะไร?", a: "เพราะแอปเปิลมีอากาศเป็นส่วนประกอบอยู่ข้างในถึง 25%" },
				{ q: "อะไรมีสถิติคร่าชีวิตคนได้มากกว่ากันระหว่าง ฉลาม กับ ตู้กดน้ำอัตโนมัติ (Vending Machine)?", a: "ตู้กดน้ำอัตโนมัติ (ล้มทับ)" },
				{ q: "แมวรับรสหวานได้หรือไม่?", a: "ไม่ได้ (ยีนรับรสหวานของพวกมันกลายพันธุ์และใช้งานไม่ได้แล้ว)" },
				{ q: "บนดาวอังคาร พระอาทิตย์ตกดินเป็นสีอะไร?", a: "สีฟ้า" },
				{ q: "ประเทศอะไรคิดค้นและผลิต 'พิซซ่าฮาวายเอี้ยน' เป็นที่แรก?", a: "แคนาดา" },
				{ q: "1 วัน กับ 1 ปี บนดาวศุกร์ อะไรยาวนานกว่ากัน?", a: "1 วัน (ดาวศุกร์หมุนรอบตัวเองช้ากว่าหมุนรอบดวงอาทิตย์)" },
				{ q: "อึของตัววอมแบท (Wombat) มีรูปร่างประหลาดอย่างไร?", a: "เป็นทรงลูกบาศก์ (สี่เหลี่ยม)" },
				{ q: "อวกาศมีกลิ่นเหมือนอะไร?", a: "สเต็กไหม้, ดินปืน หรือ โลหะเชื่อมร้อนๆ" },
				{ q: "คุณสามารถฮัมเพลง (Hum) ขณะบีบจมูกตัวเองได้หรือไม่?", a: "ไม่ได้ (เพราะลมไม่สามารถระบายออกทางจมูกได้)" },
				{ q: "รองเท้าส้นสูงในอดีตถูกออกแบบมาให้เพศใดใส่?", a: "ผู้ชาย (ทหารม้าเปอร์เซียเพื่อยึดเท้ากับโกลนม้า)" },
				{ q: "ลู่วิ่งไฟฟ้า (Treadmill) ตอนแรกถูกคิดค้นมาเพื่อใช้ทำอะไร?", a: "เป็นเครื่องจักรทรมานนักโทษในคุก" },
				{ q: "พลาสติกกันกระแทก (Bubble Wrap) ถูกตั้งใจประดิษฐ์ขึ้นมาเป็นอะไรในตอนแรก?", a: "วอลเปเปอร์ติดผนัง (แต่ไม่ได้รับความนิยม)" },
				{ q: "หากคุณสามารถพับกระดาษครึ่งหนึ่งไปเรื่อยๆ ได้ 42 ครั้ง ความหนาของมันจะไปถึงไหน?", a: "ดวงจันทร์" },
				{ q: "ลิ้นของนกหัวขวานยาวมากจนต้องพันเก็บไว้ที่ไหน?", a: "รอบกะโหลกศีรษะ (เพื่อทำหน้าที่เป็นโช้คอัพกันกระแทกสมอง)" },
				{ q: "ช่วงชีวิตของคลีโอพัตรา อยู่ใกล้กับยุคใดมากกว่ากัน ระหว่าง ยุคสร้างพีระมิด กับ ยุคเปิดตัว iPhone?", a: "ยุคเปิดตัว iPhone" },
				{ q: "บริษัทเกมนินเทนโด (Nintendo) ก่อตั้งขึ้นในปี ค.ศ. ใด?", a: "ปี 1889 (เริ่มต้นจากการผลิตไพ่ฮานะฟุดะ)" },
				{ q: "แตงโม ถือเป็นผลไม้หรือผักในตระกูลใด?", a: "ตระกูลเบอร์รี่ (Pepo)" },
				{ q: "แมงกะพรุนสายพันธุ์ Turritopsis dohrnii มีฉายาว่าอะไร?", a: "แมงกะพรุนอมตะ (สามารถย้อนวัยตัวเองกลับไปเป็นตัวอ่อนได้เรื่อยๆ)" },
				{ q: "ช้างเป็นสัตว์เลี้ยงลูกด้วยนมชนิดเดียวที่ไม่สามารถทำอะไรได้?", a: "กระโดด" },
				{ q: "ดาวเคราะห์แคระพลูโต มีพื้นที่ใหญ่หรือเล็กกว่าประเทศรัสเซีย?", a: "เล็กกว่าประเทศรัสเซีย" },
				{ q: "มวลของดวงอาทิตย์คิดเป็นกี่เปอร์เซ็นต์ของระบบสุริยะทั้งหมด?", a: "99.8%" },
				{ q: "กบดาร์วิน (Darwin's frog) ฟักไข่และเลี้ยงลูกอ๊อดที่ไหน?", a: "ในถุงเสียง (Vocal sac) และคายลูกออกมาทางปาก" },
				{ q: "เลือดของปลาหมึกยักษ์มีสีอะไร?", a: "สีน้ำเงิน (เพราะใช้โปรตีนฮีโมไซยานินที่มีทองแดงในการลำเลียงออกซิเจน)" },
				{ q: "ฟันของหอยทากมีกี่ซี่?", a: "ตั้งแต่หลักพันถึงหลักหมื่นซี่ (เรียงอยู่บนลิ้นที่เรียกว่า Radula)" },
				{ q: "ฝุ่นส่วนใหญ่ในบ้านของคุณมาจากอะไร?", a: "เซลล์ผิวหนังที่ตายแล้วของมนุษย์" },
				{ q: "ทะเลทรายซาฮาราในอดีตเมื่อหลายพันปีก่อนเคยเป็นอะไรมาก่อน?", a: "ป่าฝนเขตร้อนที่เขียวชอุ่มและมีทะเลสาบ" },
				{ q: "ปรากฏการณ์ฟ้าผ่าบนโลกเกิดขึ้นกี่ครั้งต่อวินาที?", a: "ประมาณ 100 ครั้งต่อวินาที" },
				{ q: "กล้วยมีกัมมันตภาพรังสีหรือไม่?", a: "มี (เนื่องจากโพแทสเซียม-40 แต่ต้องกินทีละหลายสิบล้านใบถึงจะเป็นอันตราย)" },
				{ q: "น้ำสามารถเดือดและกลายเป็นน้ำแข็งในเวลาเดียวกันได้หรือไม่?", a: "ได้ (ในสภาวะความดันและอุณหภูมิที่เรียกว่า จุดร่วมสาม หรือ Triple Point)" },
				{ q: "เห็ดรา (Fungi) มีความเกี่ยวข้องทางพันธุกรรมใกล้เคียงกับพืชหรือสัตว์มากกว่ากัน?", a: "สัตว์" },
				{ q: "ตัวสลอธ (Sloth) ใช้เวลาย่อยอาหารหนึ่งมื้อนานแค่ไหน?", a: "อาจนานถึง 1 เดือน" },
				{ q: "กั้งตั๊กแตนเจ็ดสี (Mantis Shrimp) ดีดหมัดได้เร็วแค่ไหน?", a: "เร็วเท่ากับกระสุนปืนลูกกรด (จนน้ำรอบๆ เดือดเป็นฟองอากาศ)" },
				{ q: "จิงโจ้สามารถเดินถอยหลังได้หรือไม่?", a: "ไม่ได้ (เพราะโครงสร้างของหางและขาหลัง)" },
				{ q: "นกอะไรที่เป็นนกชนิดเดียวในโลกที่สามารถบินถอยหลังได้?", a: "นกฮัมมิงเบิร์ด (Hummingbird)" },
				{ q: "นกกระจอกเทศมีดวงตาใหญ่กว่าสมองของมันหรือไม่?", a: "ใช่ (ดวงตาขนาดเท่าลูกบิลเลียด แต่สมองเล็กกว่า)" },
				{ q: "ฉลาม กับ ต้นไม้ อะไรมีวิวัฒนาการเกิดก่อนกันบนโลกใบนี้?", a: "ฉลาม (มีมาก่อนต้นไม้ประมาณ 90 ล้านปี)" },
				{ q: "หน้าของลูกเต๋าฝั่งตรงข้ามกัน เมื่อบวกกันจะได้ผลลัพธ์เท่าไหร่เสมอ?", a: "7 เสมอ" },
				{ q: "รอยบุ๋มบนลูกกอล์ฟมาตรฐานส่วนใหญ่มีกี่รอย?", a: "336 รอย" },
				{ q: "ชื่อเต็มจริงๆ ของตุ๊กตาบาร์บี้ (Barbie) คืออะไร?", a: "Barbara Millicent Roberts" },
				{ q: "ในเกม Super Mario Bros มาริโอ้ทุบบล็อกอิฐด้วยอวัยวะใด?", a: "หมัด (กระโดดชูหมัด ไม่ใช่เอาหัวกระแทก)" },
				{ q: "ตัวละครแพคแมน (Pac-Man) ได้แรงบันดาลใจในการออกแบบมาจากอะไร?", a: "พิซซ่าที่ถูกตัดออกไปหนึ่งชิ้น" },
				{ q: "สัญลักษณ์แฮชแท็ก (#) บนแป้นพิมพ์ มีชื่อเรียกอย่างเป็นทางการว่าอะไร?", a: "Octothorpe" },
				{ q: "แป้นพิมพ์ QWERTY ถูกออกแบบมาโดยมีจุดประสงค์หลักเพื่ออะไรในยุคแรก?", a: "เพื่อ 'ชะลอ' การพิมพ์ให้ช้าลง (ป้องกันก้านพิมพ์ขัดกันในเครื่องพิมพ์ดีดรุ่นเก่า)" },
				{ q: "ทองคำสามารถกินได้โดยปลอดภัยหรือไม่?", a: "กินได้ (ทองคำบริสุทธิ์จะไม่ทำปฏิกิริยากับสารเคมีในร่างกาย)" },
				{ q: "หมู่เกาะฮาวายกำลังเคลื่อนที่เข้าหาประเทศอะไร?", a: "ประเทศญี่ปุ่น (ด้วยแผ่นเปลือกโลกเคลื่อนตัวประมาณ 10 ซม. ต่อปี)" },
				{ q: "หอไอเฟลในฤดูร้อน กับ ฤดูหนาว ฤดูไหนมีความสูงมากกว่ากัน?", a: "ฤดูร้อน (สูงขึ้นได้ถึง 15 ซม. จากการขยายตัวของโครงสร้างเหล็กเมื่อโดนความร้อน)" },
				{ q: "น้ำลายที่มนุษย์หนึ่งคนผลิตมาตลอดชีวิต สามารถเติมเต็มสระว่ายน้ำได้กี่สระ?", a: "ประมาณ 2 สระว่ายน้ำขนาดมาตรฐานโอลิมปิก" },
				{ q: "ม้าน้ำตัวผู้หรือตัวเมีย ที่เป็นคนอุ้มท้อง?", a: "ตัวผู้" },
				{ q: "หมึกกล้วยยักษ์ (Giant Squid) มีขนาดดวงตาใหญ่เท่ากับอะไร?", a: "ลูกบาสเกตบอล (หรือขนาดเท่าจานข้าว)" },
				{ q: "ดาวเคราะห์ใดที่มีดวงจันทร์บริวารมากที่สุดในระบบสุริยะ (ข้อมูลล่าสุด)?", a: "ดาวเสาร์ (มีมากกว่า 145 ดวง)" },
				{ q: "สมองของมนุษย์ประกอบด้วยน้ำประมาณกี่เปอร์เซ็นต์?", a: "ประมาณ 73%" },
				{ q: "กระดูกของมนุษย์แข็งแกร่งกว่าวัสดุใด (หากเทียบในน้ำหนักที่เท่ากัน)?", a: "เหล็กกล้า (Steel)" },
				{ q: "สับปะรด 1 ลูก ใช้เวลาตั้งแต่ปลูกจนถึงเก็บเกี่ยวนานแค่ไหน?", a: "ประมาณ 2 ถึง 3 ปี" },
				{ q: "ช็อกโกแลต (เมล็ดโกโก้) เคยถูกใช้เป็นอะไรในยุคจักรวรรดิแอซเท็ก?", a: "เงินตรา (ใช้สำหรับแลกเปลี่ยนสินค้าแทนเงินสด)" },
				{ q: "ฟอร์จูนคุกกี้ (Fortune Cookies) มีต้นกำเนิดที่แท้จริงจากประเทศอะไร?", a: "ญี่ปุ่น (ต่อมาโด่งดังในอเมริกา ไม่ได้มาจากจีน)" },
				{ q: "ครัวซองต์ (Croissant) มีต้นกำเนิดจากประเทศอะไร?", a: "ออสเตรีย" },
				{ q: "ซีซาร์สลัด (Caesar Salad) ถูกคิดค้นที่ประเทศอะไร?", a: "เม็กซิโก" },
				{ q: "ยางรัดของ (Rubber band) จะมีอายุการใช้งานนานขึ้นถ้าเก็บไว้ที่ไหน?", a: "ในตู้เย็น (ความเย็นช่วยชะลอการเสื่อมสภาพของพอลิเมอร์)" },
				{ q: "ก๊าซฮีเลียมทำให้เสียงเราเปลี่ยนไปเพราะอะไร?", a: "เพราะความเร็วของเสียงเดินทางผ่านก๊าซฮีเลียมได้เร็วกว่าอากาศเกือบ 3 เท่า" },
				{ q: "ถั่วลิสงสามารถนำไปสกัดเป็นน้ำมันเพื่อสร้างอาวุธชนิดใด?", a: "ไดนาไมต์ (นำไปทำกลีเซอรอลเพื่อสร้างไนโตรกลีเซอรีน)" },
				{ q: "นกพิราบมีความสามารถทางสติปัญญาเทียบเท่าสัตว์ตระกูลวานรในเรื่องใด?", a: "การเข้าใจกฎเกณฑ์ทางคณิตศาสตร์พื้นฐาน" },
				{ q: "อีกาจำหน้าคนได้หรือไม่?", a: "ได้แม่นยำ และพวกมันยังสามารถเก็บความแค้นไว้ได้นานหลายปีพร้อมกับไปบอกเพื่อนอีกาตัวอื่น" },
				{ q: "ใบหน้าของมนุษย์ต่างดาว 'อีที' (E.T.) มีต้นแบบการออกแบบมาจากใคร?", a: "อัลเบิร์ต ไอน์สไตน์ ผสมกับสุนัขพันธุ์ปั๊ก และกวี คาร์ล แซนด์เบิร์ก" },
				{ q: "เลื่อยไฟฟ้า (Chainsaw) รุ่นแรกๆ ถูกประดิษฐ์ขึ้นเพื่อใช้ในวงการใด?", a: "วงการสูติกรรม (เพื่อช่วยตัดกระดูกเชิงกรานในการทำคลอดยาก)" },
				{ q: "ดวงจันทร์กำลังเคลื่อนที่เข้าหาโลก หรือ ออกห่างจากโลก?", a: "ออกห่างจากโลก (ประมาณ 3.8 เซนติเมตร ต่อปี)" },
				{ q: "ใน 1 วันที่เราบอกว่ามี 24 ชั่วโมง ความจริงแล้วโลกหมุนรอบตัวเองใช้เวลากี่ชั่วโมง?", a: "23 ชั่วโมง 56 นาที 4 วินาที (เรียกว่า วันดาราคติ)" },
				{ q: "ถ้าคุณขุดหลุมทะลุโลกไปอีกฝั่งแล้วกระโดดลงไป คุณจะใช้เวลาตกลงไปกี่นาที?", a: "ประมาณ 42 นาที (ในทางทฤษฎี)" }
            ],
            other: [
